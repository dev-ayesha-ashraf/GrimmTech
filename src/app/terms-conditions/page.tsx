...
const termsSections: TermsSection[] = [
    ...
    content: (
      <div className="space-y-3">
        <p className="text-gray-700 text-md leading-relaxed">
          Legal agreement between Grimm Technologies and our users for advanced computational and AI services.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-primary]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-primary] text-md">Content</h4>
            <p className="text-md text-gray-600">
          ...
          <div className="bg-white border border-gray-200 rounded p-3 hover:border-[brand-primary]/50 transition-colors duration-200">
            <h4 className="font-semibold text-gray-800 mb-1 text-[brand-primary] text-md">Intellectual Property</h4>
            <p className="text-md text-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white border border-gray-200 rounded p-4">
            <div className="flex items-center mb-2">
              <div className="w-8 h-8 rounded-full bg-[brand-primary] flex items-center justify-center mr-2">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-blue-50 border-l-3 border-[brand-primary] p-4 rounded-r text-md\">
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index} className="flex items-start text-md">
                  <svg className="w-4 h-4 text-[brand-primary] mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto text-md">
                Rules and guidelines for interacting with Grimm Technologies's intelligent platforms.
              </p>
            </div>
          </div>
        </div>
