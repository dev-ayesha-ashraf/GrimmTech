...
const policySections: RefundPolicySection[] = [
    ...
    content: (
      <div className="space-y-3">
        <div className="flex items-start">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[brand-primary]/20 flex items-center justify-center mr-2 mt-0.5">
        ...
        <div className="flex items-start">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[brand-primary]/20 flex items-center justify-center mr-2 mt-0.5">
            <span className="text-sm font-semibold text-[brand-primary]">2</span>
          </span>
          <p className="text-gray-700 text-md leading-relaxed">
        ...
        <div className="flex items-start">
          <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[brand-primary]/20 flex items-center justify-center mr-2 mt-0.5">
            <span className="text-sm font-semibold text-[brand-primary]">3</span>
          </span>
          <p className="text-gray-700 text-md leading-relaxed">
  ...
  },
  {
    ...
    content: (
      <div className="bg-gradient-to-r from-[brand-primary]/5 to-white p-4 rounded border border-[brand-primary]/20">
        <p className="text-gray-700 text-md leading-relaxed mb-3">
          ...
          <a
            ...
            className="font-semibold text-[brand-primary] hover:text-[#1a8ec9] hover:underline transition-colors duration-200"
          >
        ...
        <div className="flex items-center text-sm text-gray-600">
          <svg className="w-4 h-4 mr-2 text-[brand-primary]" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    content: (
      <div className="bg-blue-50 border-l-3 border-[brand-primary] p-4 rounded text-md">
  ...
  },
  {
    ...
    title: "CONTACT US",
    content: (
      <div className="bg-gradient-to-r from-[brand-primary]/10 to-[brand-primary]/5 p-4 rounded border border-[brand-primary]/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="flex items-center p-2 bg-white rounded border border-gray-200">
            <svg className="w-4 h-4 text-[brand-primary] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                policySections.map((section) => (
                  <div key={section.id} className="rounded-lg overflow-hidden border border-gray-200">
                    ...
                    >
                      ...
                      <span className={`text-[brand-primary] text-xl transition-transform duration-300 ${activeSection === section.id ? 'rotate-180' : ''}`}>
                        ▾
                      </span>
                    </button>
